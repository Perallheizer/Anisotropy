...
def chi2_wrapper(H0_p, q0_p, M_p, H0_m, q0_m, M_m, idx_plus, idx_minus, z_sn, mb, L, mu_ceph, calibrator):
    return chisq_sne([H0_p, q0_p, M_p, H0_m, q0_m, M_m], idx_plus, idx_minus, z_sn, mb, L, mu_ceph, calibrator)
    
def fit_joint(idx_plus, idx_minus, z_sn, mb, L, mu_ceph, calibrator):

    func = lambda H0_p, q0_p, M_p, H0_m, q0_m, M_m: chi2_wrapper(H0_p, q0_p, M_p, H0_m, q0_m, M_m, idx_plus, idx_minus, z_sn, mb, L, mu_ceph, calibrator)
