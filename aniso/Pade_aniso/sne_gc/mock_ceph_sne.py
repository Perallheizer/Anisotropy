...
def chi2_wrapper(H0_p, q0_p, M_p, k_p, s_p, sig_p,
...
def fit_joint(idx_sn_p, idx_sn_m, idx_gc_p, idx_gc_m, z_sn, mb, L, mu_ceph, calibrator, z_gc, sig_L, f, logT_err, tau): 
    ...
    func = lambda H0_p, q0_p, M_p, k_p, s_p, sig_p, H0_m, q0_m, M_m, k_m, s_m, sig_m: chi2_wrapper(H0_p, q0_p, M_p, k_p, s_p, sig_p, H0_m, q0_m, M_m, k_m, s_m, sig_m, idx_sn_p, idx_sn_m, idx_gc_p, idx_gc_m, z_sn, mb, L, mu_ceph, calibrator, z_gc, sig_L, f, logT_err, tau)
